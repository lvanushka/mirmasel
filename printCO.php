...
if(!(isset($_SESSION["userRole"]))||$_SESSION["userRole"]!=0){header("Location:/index.php");die();}
$timez='+interval 4 hour';
$userId=$_SESSION["userID"];
$cashId=$_REQUEST['cashId'];
echo '<!DOCTYPE html><html><head><meta charset="utf-8"><link rel="stylesheet" href="style/printList.css" type="text/css"/>'
. '<title>Изъятие наличных'.$orderId.'</title>'.'<link rel="stylesheet" href="style/print.css" type="text/css"/>'
